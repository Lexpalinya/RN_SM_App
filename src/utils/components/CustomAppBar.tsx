...
const CustomAppBar: React.FC<CustomAppBarProps> = ({ title = "ນັກລ່າຄວາມຝັນ", Icon = MaterialSymbolsArrowBackIosRounded }) => {
    ...
    return (
        <View style={styles.container}>
            {Icon && <TouchableOpacity onPress={() => handleBack()} style={styles.iconContainer}>
